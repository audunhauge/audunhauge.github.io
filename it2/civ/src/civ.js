...
declare function AsyncAstar(obj: Object): any;
declare function build(w: any, h: any, l: any, s: any, r: any, f: any): any;

declare function neighbours(x: number, y: number, w: number, h: number): any;

declare var document: any;  // flow is unsure about document eventlistener 
declare var Math: any; // avoid spurious error on Math.seedrandom


declare class Unit {
    constructor(name: string, b: any): any;
}

declare class Settler {
    constructor(b: any, builder: any): any;
}
...
function civ(params) {
    ...
    let divMain: any = document.getElementById("main");
    let divBoard: any = document.getElementById("board");
    let cvsMiniMap: any = document.getElementById("minimap");
