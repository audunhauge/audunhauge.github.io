 ...
 * @param {String} sql 
 */
function sql2postgres(sql, backend) {
...
=======
      ...
      r.unshift( [tname+'id', ' serial primary key' ]);  // primary autoincrement key
      td[tname] = r.map(e => e.join(" ")).join(",\n  ");
>>>>>>> bdb83e2889c7a8f933ca4832d7e0751bf3a0d441
    }
  });
...
function sql2class(sql) {
  ...
  s.push(`
let autokeys = {
    ${Object.keys(td).map(t => `${t}id:0`).join(",")}
} 
`);
  return { s, td };
}
